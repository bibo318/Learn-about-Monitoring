...
Đặt pass 
```sh
/usr/bin/mysqladmin -u root password 'DMG389999'
```

Tạo DB:

```sh
mysql -u root -p'DMG389999'
CREATE DATABASE nagios DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE USER 'ndoutils'@'%' IDENTIFIED BY 'DMG389999';
GRANT USAGE ON *.* TO 'ndoutils'@'%' IDENTIFIED BY 'DMG389999' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
...
```sh
GRANT USAGE ON *.* TO 'ndoutils'@'localhost' IDENTIFIED BY 'DMG389999' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
...
```sh
[root@DMG38-68-110 ndoutils-2.1.3]# find / -name mysql_config
...
```sh
[root@DMG38-68-110 ndoutils-2.1.3]# make all
...
```sh
[root@DMG38-68-110 ndoutils-2.1.3]# vim Makefile
...
...
# Configure Database
cd db/
./installdb -u 'ndoutils' -p 'DMG389999' -h '127.0.0.1' -d nagios
cd ..
```
...
```sh
echo 'show databases;' | mysql -u ndoutils -p'DMG389999' -h 127.0.0.1
echo 'show tables;' | mysql -u ndoutils -p'DMG389999' nagios -h 127.0.0.1
...
[root@DMG38-68-110 ndoutils-2.1.3]# systemctl status  mariadb
...
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140641378236608 [Note] InnoDB: 5.7.27 started; log sequence number 1620333
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140640574760704 [Note] InnoDB: Loading buffer pool(s) from /var/lib/mysql/ib_buffer_pool
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140640574760704 [Note] InnoDB: Buffer pool(s) load completed at 191029 15:47:42
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140641378236608 [Note] Plugin 'FEEDBACK' is disabled.
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140641378236608 [Note] Server socket created on IP: '::'.
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140641378236608 [Note] Reading of all Master_info entries succeeded
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140641378236608 [Note] Added new Master_info '' to hash table
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: 2019-10-29 15:47:42 140641378236608 [Note] /usr/sbin/mysqld: ready for connections.
Oct 29 15:47:42 DMG38-68-110 mysqld[12947]: Version: '10.2.27-MariaDB'  socket: '/var/lib/mysql/mysql.sock'  port: 3306  MariaDB Server
Oct 29 15:47:42 DMG38-68-110 systemd[1]: Started MariaDB 10.2.27 database server.
```

* Kiểm tra trạng thái của ndo2db mà thấy lỗi sau

```sh
[root@DMG38-68-110 db]# systemctl status  ndo2db mariadb
...
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: Error: mysql_query() failed for 'INSERT INTO nagios_logentries SET instance_id='1', logentry_time=FROM_UNIXTIME(15723...fo
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: mysql_error: 'Data too long for column 'logentry_data' at row 1'
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: Error: mysql_query() failed for 'INSERT INTO nagios_logentries SET instance_id='1', logentry_time=FROM_UNIXTIME(15723...CR
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: mysql_error: 'Data too long for column 'logentry_data' at row 1'
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: Error: mysql_query() failed for 'INSERT INTO nagios_logentries SET instance_id='1', logentry_time=FROM_UNIXTIME(15723...CR
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: mysql_error: 'Data too long for column 'logentry_data' at row 1'
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: Error: mysql_query() failed for 'INSERT INTO nagios_logentries SET instance_id='1', logentry_time=FROM_UNIXTIME(15723...IT
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: mysql_error: 'Data too long for column 'logentry_data' at row 1'
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: Error: mysql_query() failed for 'INSERT INTO nagios_logentries SET instance_id='1', logentry_time=FROM_UNIXTIME(15723...IT
Oct 29 14:49:15 DMG38-68-110 ndo2db[5157]: mysql_error: 'Data too long for column 'logentry_data' at row 1'
```
...
```sh
mysql -u root -pDMG389999 nagios
...
```sh
[root@DMG38-68-110 ndoutils-2.1.3]# systemctl status ndo2db
● ndo2db.service - Nagios Data Out Daemon
   Loaded: loaded (/usr/lib/systemd/system/ndo2db.service; enabled; vendor preset: disabled)
...
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming systemcommands.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming servicechecks.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming hostchecks.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming eventhandlers.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming externalcommands.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming notifications.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming contactnotifications.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming contactnotificationmethods.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming logentries.
Oct 29 15:57:45 DMG38-68-110 ndo2db[14340]: Trimming acknowledgements.
```
...
```sh
[root@DMG38-68-110 NagiosReport]# systemctl status  ndo2db
● ndo2db.service - Nagios Data Out Daemon
   Loaded: loaded (/usr/lib/systemd/system/ndo2db.service; enabled; vendor preset: disabled)
...
Oct 28 09:14:05 DMG38-68-110 systemd[1]: Started Nagios Data Out Daemon.
Oct 28 09:14:05 DMG38-68-110 ndo2db[616]: Could not bind socket: Address already in use
Oct 28 09:14:05 DMG38-68-110 systemd[1]: ndo2db.service: main process exited, code=exited, status=1/FAILURE
Oct 28 09:14:05 DMG38-68-110 systemd[1]: Unit ndo2db.service entered failed state.
Oct 28 09:14:05 DMG38-68-110 systemd[1]: ndo2db.service failed.
```
...
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming systemcommands.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming servicechecks.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming hostchecks.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming eventhandlers.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming externalcommands.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming notifications.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming contactnotifications.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming contactnotificationmethods.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming logentries.
Oct 28 10:54:02 DMG38-68-110 ndo2db[1008]: Trimming acknowledgements.
```
